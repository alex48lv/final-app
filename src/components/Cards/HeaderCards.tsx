...
const Arrow = styled.div<{ left?: boolean }>`
  ...
  top: 40%;
  right: 1rem;
  background: url(${rightIcon}) rgba(249, 247, 247, 0.5) center/contain no-repeat;
  width: 2rem;
  height: 2rem;
  cursor: pointer;
...
const HeaderCards: React.FC = () => {
    ...
    return (
        <>
            <Card>
                <Slide bg={sliderData[currentSlide1].img} to={sliderData[currentSlide1].url} />
            ...
            <Card>
                <Slide bg={sliderData[currentSlide2].img} to={sliderData[currentSlide2].url} />
